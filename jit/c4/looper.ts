...
module J2ME.C4.Looper {
  import top = ArrayUtilities.top;
  import peek = ArrayUtilities.peek;
  ...
  import BITS_PER_WORD = BitSets.BITS_PER_WORD;
  import ADDRESS_BITS_PER_WORD = BitSets.ADDRESS_BITS_PER_WORD;
  import BIT_INDEX_MASK = BitSets.BIT_INDEX_MASK;
  
  export class BlockSet extends BitSets.Uint32ArrayBitSet {
    constructor(length: number, public blockById: Map<number, Block>) {
      super(length);
    }
