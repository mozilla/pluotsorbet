...
module J2ME {
  ...
  export class JVM {
    ...
    startIsolate0(className: string, args: string []) {
      ...
      ctx.start([
        Frame.create(isolateClassInfo.getMethodByNameString("start", "()V", false), [ isolate ], 0),
        Frame.create(isolateClassInfo.getMethodByNameString("<init>", "(Ljava/lang/String;[Ljava/lang/String;)V", false),
    ...
    startIsolate(isolate: Isolate) {
      ...
      ctx.start([
        ...
        Frame.create(CLASSES.java_lang_Thread.getMethodByNameString("<init>", "(Ljava/lang/String;)V", false),
