...
public class MIDletProxyList
        implements MIDletControllerEventConsumer,
                   SuspendSystemListener,
                   MIDletControllerNativeEventConsumer {
    ...
    MIDletProxyList(EventQueue eventQueue) {
        ...
        new MIDletControllerNativeEventListener(eventQueue, this);
    }
    ...
    public void handleNativeMidletDestroyEvent(
        ...
        MIDletProxy midletProxy = findMIDletProxy(suiteId,
                                                  midlet);
        if (midletProxy == null) {
            return;
        }
