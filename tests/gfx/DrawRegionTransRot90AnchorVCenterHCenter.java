...
public class DrawRegionTransRot90AnchorVCenterHCenter extends MIDlet {
    ...
    class TestCanvas extends Canvas {
        protected void paint(Graphics screenG) {
            ...
            screenG.drawRegion(image, 10, 15, 70, 95, Sprite.TRANS_ROT90, getWidth() / 2, getHeight() / 2, Graphics.VCENTER | Graphics.HCENTER);
            System.out.println("PAINTED");
        }
    }

    public DrawRegionTransRot90AnchorVCenterHCenter() {
