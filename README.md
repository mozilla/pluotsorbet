...
PluotSorbet implements a Java-compatible virtual machine and J2ME-compatible platform written in JavaScript<sup>[[1]](#user-content-JavaScript)</sup>. The goal of PluotSorbet is to run MIDlets in web apps without a native plugin.
